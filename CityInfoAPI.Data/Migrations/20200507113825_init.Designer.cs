...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CityInfoAPI.Data.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CityInfoAPI.Data.Entities.CityLanguage", b =>
                {
            ...
            modelBuilder.Entity("CityInfoAPI.Data.Entities.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CityInfoAPI.Data.Entities.PointOfInterest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CityInfoAPI.Data.Entities.CityLanguage", b =>
                {
                    b.HasOne("CityInfoAPI.Data.Entities.City", "City")
                        .WithMany("CityLanguages")
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CityInfoAPI.Data.Entities.Language", "Language")
                        .WithMany("CityLanguages")
